document.addEventListener('DOMContentLoaded', () => {
    ...
    const TRANSLATIONS = {
        ja: {
            ...
            "menu-item-desc-3": "自家製パン2種、地元産の卵とベーコンの絶品ベーコンエッグ、サラダ、スープにコーヒーまたは紅茶がセットになった数量限定モーニングプレート。ドリンクの変更は+100円で承ります。高原での心地よい朝活におすすめです。",
        ...
        en: {
            ...
            "menu-item-desc-3": "A limited breakfast plate featuring two types of homemade bread, delicious local bacon and eggs, salad, soup, and coffee or tea (drink changes available for +100 yen). Recommended for a refreshing start to your morning.",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
        ...
        zh: {
            ...
            "menu-item-desc-3": "限量供应的早餐拼盘，包含两种手工面包、当地特产鸡蛋和培根制作的培根煎蛋、沙拉、汤以及咖啡或红茶（加100日元可更换其他饮品）。非常推荐在高原开启清晨的活力时光。",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
        ...
        ko: {
            ...
            "menu-item-desc-3": "수제 빵 2종과 현지산 계란 & 베이컨으로 만든 베이컨 에그, 샐러드, 수프와 함께 커피 또는 홍차가 세트로 제공되는 수량 한정 모닝 플레이트(100엔 추가 시 다른 음료로 변경 가능). 고원에서의 상쾌한 아침 활동에 추천합니다.",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
