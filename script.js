document.addEventListener('DOMContentLoaded', () => {
    ...
    const TRANSLATIONS = {
        ja: {
            ...
            "concept-desc-2": "かつてこの場所で愛されていた田舎料理店「たぬき八」の跡地を受け継ぎ、移住してきた私たちオーナー夫婦が自らの手でDIYリノベーションを行って、温もりあふれるカフェへと生まれ変わらせました。",
            ...
            "menu-item-desc-1": "可愛い「たぬき」の焼き印が押された当店自慢のホットサンド。定番のハム＆チーズから甘めのブルーベリー＆クリームチーズまでご用意。すべてのホットサンドの耳を落とし、ふんわりホイップを添えて提供しています。",
            "menu-item-price-1": "¥550 〜",
            "menu-tag-2": "Espresso",
            "menu-item-title-2": "エスプレッソ & カフェラテ",
            "menu-item-desc-2": "専用のマシンで丁寧に抽出した薫り高いエスプレッソとカフェラテ（ラテアート）に加え、カフェモカやキャラメルラテなどの甘めのアレンジドリンクもお楽しみいただけます。",
            "menu-item-price-2": "¥400 〜",
            "menu-tag-3": "Morning",
            "menu-item-title-3": "モーニングプレート [数量限定]",
            "menu-item-desc-3": "自家製パン2種、地元産の卵とベーコンの絶品ベーコンエッグ、サラダ、スープにコーヒーまたは紅茶がセットになった数量限定モーニングプレート。高原での心地よい朝活におすすめです。",
        ...
        en: {
            ...
            "menu-item-desc-1": "Our signature hot sandwich stamped with our cute raccoon dog logo. We offer flavors from classic ham & cheese to sweet Blueberry & Cream Cheese. All hot sandwiches have their crusts removed and are served with fluffy whipped cream.",
            "menu-item-price-1": "¥550 ~",
            "menu-tag-2": "Espresso",
            "menu-item-title-2": "Espresso & Cafe Latte",
            "menu-item-desc-2": "Enjoy rich, aromatic espresso and cafe latte (with beautiful latte art) pulled from our professional machine, alongside sweet specialty drinks like cafe mocha and caramel latte.",
            "menu-item-price-2": "¥400 ~",
            "menu-tag-3": "Morning",
            "menu-item-title-3": "Morning Plate [Limited]",
            "menu-item-desc-3": "A limited breakfast plate featuring two types of homemade bread, delicious local bacon and eggs, salad, soup, and coffee or tea. Recommended for a refreshing start to your morning.",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
        ...
        zh: {
            ...
            "menu-item-desc-1": "印有可爱“狸猫”图案的招牌热压三明治。提供从经典的火腿芝士到甜甜的蓝莓奶油芝士等多种口味。所有热三明治均切掉面包边，并附赠松软的鲜奶油。",
            "menu-item-price-1": "¥550 〜",
            "menu-tag-2": "Espresso",
            "menu-item-title-2": "浓缩咖啡 & 拿铁",
            "menu-item-desc-2": "除了使用专用咖啡机精心意式浓缩，与细腻奶泡交融成精美的拿铁拉花之外，店内还提供摩卡咖啡、焦糖拿铁等口味香甜的花式饮品。",
            "menu-item-price-2": "¥400 〜",
            "menu-tag-3": "Morning",
            "menu-item-title-3": "限量早餐拼盘 [数量限定]",
            "menu-item-desc-3": "限量供应的早餐拼盘，包含两种手工面包、当地特产鸡蛋和培根制作的培根煎蛋、沙拉、汤以及咖啡或红茶。非常适合在高原开启清晨的活力时光。",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
        ...
        ko: {
            ...
            "menu-item-desc-1": "귀여운 '너구리' 낙인이 찍힌 저희 카페의 자랑인 핫샌드위치. 클래식한 햄 & 치즈부터 달콤한 블루베리 & 크림치즈까지 제공합니다. 모든 핫샌드위치는 테두리를 잘라내고 부드러운 휘핑크림을 곁들여 제공합니다.",
            "menu-item-price-1": "¥550 〜",
            "menu-tag-2": "Espresso",
            "menu-item-title-2": "에스프레소 & 카페라떼",
            "menu-item-desc-2": "전용 머신으로 정성껏 추출한 깊은 풍미의 에스프레소와 카페라떼(라떼아트)를 비롯해, 카페모카와 카라멜라떼 등 달콤한 에스프레소 베이스 음료도 준비되어 있습니다.",
            "menu-item-price-2": "¥400 〜",
            "menu-tag-3": "Morning",
            "menu-item-title-3": "수량 한정 모닝 플레이트 [수량 한정]",
            "menu-item-desc-3": "수제 빵 2종과 현지산 계란 & 베이컨으로 만든 베이컨 에그, 샐러드, 수프와 함께 커피 또는 홍차가 세트로 제공되는 수량 한정 모닝 플레이트. 고원에서의 상쾌한 아침 활동에 추천합니다.",
            "menu-item-price-3": "¥1,380",
            "menu-tag-4": "Ambiance",
